    ...
    <header class="bg-white sticky top-0 z-50 shadow-sm border-b border-gray-100">
        <div class="max-w-[1400px] mx-auto px-4 md:px-8 py-3 flex justify-between items-center">
                    ...
                    <div class="absolute top-full left-0 mt-2 w-[650px] bg-white rounded-2xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 p-6">
                        <div class="grid grid-cols-5 gap-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <div class="space-y-2 pl-1">
                                            <a href="/category.php?slug=life" class="flex items-center gap-2 text-sm text-brand-text hover:text-brand-navy transition"><i data-lucide="heart" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันชีวิต</a>
                                            <a href="/category.php?slug=savings" class="flex items-center gap-2 text-sm text-brand-text hover:text-brand-navy transition"><i data-lucide="landmark" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันเงินออม</a>
                                            <a href="/category.php?slug=pension" class="flex items-center gap-2 text-sm text-brand-text hover:text-brand-navy transition"><i data-lucide="home" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันเกษียณ</a>
                                        </div>
                                    </div>
                                    <div>
                                        <p class="text-[11px] font-bold text-brand-gray uppercase tracking-wider mb-2">ประกันเสริม</p>
                                        <div class="space-y-2 pl-1">
                                            <a href="/category.php?slug=health" class="flex items-center gap-2 text-sm text-brand-text hover:text-brand-navy transition"><i data-lucide="activity" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันสุขภาพ</a>
                                            <a href="/category.php?slug=critical" class="flex items-center gap-2 text-sm text-brand-text hover:text-brand-navy transition"><i data-lucide="shield-alert" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันโรคร้ายแรง</a>
                                            <a href="/category.php?slug=income" class="flex items-center gap-2 text-sm text-brand-text hover:text-brand-navy transition"><i data-lucide="dollar-sign" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันชดเชยรายได้</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-2 border-l border-gray-100 pl-6">
                                ...
                                <div class="space-y-2 pl-1">
                                    <a href="/category.php?slug=group" class="flex items-center gap-2 text-sm text-brand-text hover:text-brand-navy transition"><i data-lucide="users" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันกลุ่ม</a>
                                    <a href="/category.php?slug=corporate" class="flex items-center gap-2 text-sm text-brand-text hover:text-brand-navy transition"><i data-lucide="briefcase" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันนิติบุคคล</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="https://line.me/R/ti/p/@945ampel" target="_blank" rel="noopener" class="hidden md:flex items-center gap-2 bg-brand-navy hover:bg-brand-navyHover text-white px-5 py-2.5 rounded-full text-sm font-semibold transition shadow-md">
        ...
        <div id="mobile-menu" class="fixed top-0 right-0 w-72 h-full bg-white z-50 transform translate-x-full shadow-2xl flex flex-col">
            ...
            <div class="p-4 flex flex-col gap-3 text-sm font-medium overflow-y-auto pb-20">
                        ...
                        <div>
                            ...
                            <div class="space-y-2 pl-3 mb-3">
                                ...
                                <div class="space-y-1.5 pl-2">
                                    <a href="/category.php?slug=life" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="heart" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันชีวิต</a>
                                    <a href="/category.php?slug=savings" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="landmark" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันเงินออม</a>
                                    <a href="/category.php?slug=pension" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="home" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันเกษียณ</a>
                                </div>
                                <p class="text-[10px] font-bold text-brand-gray/70 uppercase tracking-wider mt-2">ประกันเสริม</p>
                                <div class="space-y-1.5 pl-2">
                                    <a href="/category.php?slug=health" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="activity" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันสุขภาพ</a>
                                    <a href="/category.php?slug=critical" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="shield-alert" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันโรคร้ายแรง</a>
                                    <a href="/category.php?slug=income" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="dollar-sign" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันชดเชยรายได้</a>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="space-y-1.5 pl-3">
                                <a href="/category.php?slug=group" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="users" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันกลุ่ม</a>
                                <a href="/category.php?slug=corporate" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="briefcase" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันนิติบุคคล</a>
                                <a href="/category.php?slug=car" class="flex items-center gap-2 text-sm hover:text-brand-navy transition"><i data-lucide="car" class="w-3.5 h-3.5 text-brand-navy shrink-0"></i> ประกันรถยนต์</a>
                ...
                <hr>
                <a href="https://line.me/R/ti/p/@945ampel" target="_blank" rel="noopener" class="flex items-center justify-center gap-2 bg-brand-navy text-white px-5 py-3 rounded-xl text-sm font-semibold w-full mt-2">
                    <img src="/assets/icon/line.svg" class="w-4 h-4" alt="LINE"> ปรึกษาฟรี
                </a>
            </div>
        </div>
