...
<section class="py-16">
    <div class="max-w-[1400px] mx-auto px-4 md:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php
            $testimonials = [
                ['name' => 'คุณธนธัช', 'tag' => 'ประกันชีวิต', 'rating' => 5, 'text' => 'ขอบคุณพี่ป๊อบมากครับ ที่ช่วยแนะนำแผนประกันชีวิตที่เหมาะกับเราจริงๆ หลังจากคุยกันพี่ป๊อบเข้าใจความต้องการของเรามาก แนะนำแผนที่คุ้มค่าและตรงกับที่เราต้องการ ไม่ได้ขายแบบยัดเยียดเลย ไว้ต่ออายุจะมาหาพี่ป๊อบอีก'],
                ['name' => 'คุณพรรณนิภา', 'tag' => 'ประกันสุขภาพ', 'rating' => 5, 'text' => 'ประทับใจมากค่ะ พี่ป๊อบดูแลอย่างดีตั้งแต่แรกจนถึงตอนเคลม เคยเคลมประกันสุขภาพไปรอบนึง พี่ป๊อบช่วยดำเนินการให้ทุกอย่าง เคลมไวมาก ได้เงินเร็ว ไม่ต้องปวดหัวกับเอกสารเลย แนะนำให้เพื่อนๆ มาหาพี่ป๊อบกันหลายคนแล้ว'],
                ['name' => 'คุณวีรัตน์', 'tag' => 'ประกันชีวิต', 'rating' => 5, 'text' => 'ไว้ใจพี่ป๊อบมาตลอด 10 ปี ตั้งแต่ทำประกันชีวิตกับพี่ป๊อบตอนแรกก็รู้สึกดีที่ได้รับคำแนะนำที่ดี พี่ป๊อบไม่เคยทิ้ง ดูแลต่อเนื่องทุกปี มีอะไรอัปเดตก็แจ้งตลอด ผมแนะนำให้คนในครอบครัวมาทำกับพี่ป๊อบทุกคน'],
                ['name' => 'คุณณัฐวุฒิ', 'tag' => 'ประกันอุบัติเหตุ', 'rating' => 5, 'text' => 'พี่ป๊อบเป็นกันเองมาก ให้คำปรึกษาดีมาก ไม่ได้ขายอย่างเดียว แต่ให้ความรู้เกี่ยวกับการวางแผนการเงินด้วย ทำให้เราเข้าใจมากขึ้นว่าทำไมต้องมีประกันแต่ละแบบ สุดยอดครับ'],
                ['name' => 'คุณกัญญา', 'tag' => 'ประกันสุขภาพเด็ก', 'rating' => 5, 'text' => 'ตอนแรกกังวลเรื่องทำประกันให้ลูกมาก ไม่รู้ว่าจะเลือกแบบไหน พี่ป๊อบแนะนำละเอียดมาก ทั้งข้อดีข้อเสียของแต่ละแผน ทำให้ตัดสินใจได้ง่ายขึ้น ตอนนี้ลูกสบายใจ อุ่นใจที่มีประกันให้ลูก'],
                ['name' => 'คุณสมชาย', 'tag' => 'ประกันบำนาญ', 'rating' => 5, 'text' => 'วางแผนเกษียณกับพี่ป๊อบ รู้สึกมั่นใจมากขึ้น พี่ป๊อบคำนวณให้เห็นเป็นรูปธรรมว่าเราต้องมีเงินเท่าไหร่ถึงจะเกษียณอย่างสบาย และเลือกแผนประกันที่ช่วยให้เราไปถึงเป้าหมายนั้นได้'],
                ['name' => 'คุณรุ่งนภา', 'tag' => 'ประกันโรคร้ายแรง', 'rating' => 5, 'text' => 'พอมีคนในครอบครัวเป็นมะเร็ง ทำให้เห็นความสำคัญของประกันโรคร้ายแรง พี่ป๊อบช่วยเลือกแผนที่คุ้มครองครอบคลุมมากที่สุดในราคาที่จ่ายไหว ขอบคุณมากค่ะ'],
                ['name' => 'คุณอภิชาติ', 'tag' => 'ประกันกลุ่มองค์กร', 'rating' => 5, 'text' => 'บริษัทผมทำประกันกลุ่มกับพี่ป๊อบ บริการดีมาก พนักงานในบริษัทพอใจกันทุกคน พี่ป๊อบดูแลตั้งแต่การเสนอแผนจนถึงการเคลม ไว้วางใจได้ 100%'],
                ['name' => 'คุณดาริกา', 'tag' => 'ประกันเดินทาง', 'rating' => 5, 'text' => 'ก่อนไปเที่ยวต่างประเทศพี่ป๊อบแนะนำให้ทำประกันเดินทาง ตอนแรกคิดว่าไม่จำเป็น แต่ดันเจ็บป่วยระหว่างทริป โทรหาพี่ป๊อบ พี่ป๊อบจัดการให้ทุกอย่าง คุ้มค่ามากที่ทำไว้'],
                ['name' => 'คุณธนากร', 'tag' => 'ประกันชีวิต', 'rating' => 5, 'text' => 'พี่ป๊อบเป็นมากกว่าตัวแทนประกัน คือที่ปรึกษาทางการเงินที่ไว้ใจได้ ปรึกษาได้ทุกเรื่อง วางแผนการเงินให้ครอบคลุมทั้งประกัน การออม และการลงทุน ขอบคุณครับ'],
                ['name' => 'คุณสุภาพร', 'tag' => 'ประกันสุขภาพ', 'rating' => 5, 'text' => 'เคลมประกันสุขภาพรอบที่แล้วรู้สึกว่าง่ายมาก แค่ส่งเอกสารให้พี่ป๊อบ ที่เหลือพี่ป๊อบดำเนินการให้หมด เงินเข้าบัญชีไวมาก ประทับใจบริการหลังการขาย'],
